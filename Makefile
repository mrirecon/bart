...
XTARGETS = $(TRECO) $(TCALIB) $(TESTVAR) $(TMRI) $(TSIM)
...
MODULES_bart += -lbox -lbox2 -lgrecon -lsense -lnoir -lwavelet2 -liter -llinops -lwavelet3 -llowrank -lnoncart -lcalib -lsimu -lsake -lestvar
MODULES_sake += -lsake
