...
TRECO=pics pocsense sqpics itsense nlinv moba nufft nufftbase rof tgv ictv sake wave lrmatrix estdims estshift estdelay wavepsf wshfl rtnlinv mobafit grog denoising
...
MODULES_denoising = -lgrecon -liter -llinops -lwavelet -llowrank -lnoncart -lnn -lnlops
