...
tests/test-ictv-denoise: phantom slice noise fft ones pics denoise slice nrmse
...
tests/test-ictgv-denoise: phantom slice noise fft ones pics denoise slice nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)					;\
	$(TOOLDIR)/phantom -s2 x.ra							;\
	$(TOOLDIR)/noise -n 1000000. x.ra xn.ra					;\
...
tests/test-ictv-denoise2: phantom slice vec transpose fmac noise denoise repmat saxpy nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)					;\
