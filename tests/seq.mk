...
tests/test-seq-raga: seq traj transpose slice join nrmse
	...
	$(TOOLDIR)/slice 0 3 samples.ra samples_t0.ra 				;\
	$(TOOLDIR)/slice 0 2 samples.ra samples_t1.ra 				;\
	$(TOOLDIR)/slice 0 4 samples.ra samples_t2.ra 				;\
...
tests/test-seq-raga-sms-al-frame: seq traj transpose slice join nrmse
	...
	$(TOOLDIR)/slice 0 3 samples_tt.ra samples_t0.ra 							;\
	$(TOOLDIR)/slice 0 2 samples_tt.ra samples_t1.ra 							;\
	$(TOOLDIR)/slice 0 4 samples_tt.ra samples_t2.ra 							;\
	$(TOOLDIR)/join 0 samples_t0.ra samples_t1.ra samples_t2.ra trj_seq.ra 					;\
	$(TOOLDIR)/nrmse -t 2e-7 trj_ref.ra trj_seq.ra								;\
	rm *.ra ; cd .. ; rmdir $(TESTS_TMP)
	touch $@
