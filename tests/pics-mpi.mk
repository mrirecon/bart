...
TESTS_SLOW += tests/test-pics-cart-mpi_shared tests/test-pics-cart-mpi-multipledims tests/test-pics-cart-mpi-multipledims-sharedcoil
TESTS_SLOW += tests/test-pics-noncart-sms-mpi
endif
