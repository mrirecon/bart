tests/test-sim-to-signal-irflash: sim cabs mip spow fmac signal nrmse
	...
	$(TOOLDIR)/sim --sim ir-flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 _simu.ra ;\
...
tests/test-sim-to-signal-flash: sim cabs mip spow fmac signal nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 _simu.ra ;\
	$(TOOLDIR)/cabs _simu.ra _simu_abs.ra								;\
	$(TOOLDIR)/mip 32 _simu_abs.ra max.ra								;\
	$(TOOLDIR)/spow -- -1 max.ra scale.ra								;\
	$(TOOLDIR)/fmac _simu.ra scale.ra simu.ra 							;\
...
tests/test-sim-to-signal-irbSSFP: sim signal nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim ir-bssfp,tr=0.0045,te=0.00225,nrep=1000,ipl=0,ppl=0,trf=0,fa=45,bwtp=4 -1 3:3:1 -2 1:1:1 sim.ra ;\
...
tests/test-sim-ode-hp-irflash: sim nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim ir-flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0.0001,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 simu_ode.ra ;\
	$(TOOLDIR)/sim --sim ir-flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 simu_hp.ra ;\
...
tests/test-sim-ode-hp-flash: sim nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0.0001,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 simu_ode.ra ;\
	$(TOOLDIR)/sim --sim flash,tr=0.0041,te=0.0025,nrep=1000,ipl=0,ppl=0,trf=0,fa=8,bwtp=4 -1 3:3:1 -2 1:1:1 simu_hp.ra ;\
	$(TOOLDIR)/nrmse -t 0.0006 simu_hp.ra simu_ode.ra			    	;\
	rm *.ra ; cd .. ; rmdir $(TESTS_TMP)
	touch $@
...
tests/test-sim-ode-hp-irbssfp: sim nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim ir-bssfp,tr=0.0045,te=0.00225,nrep=1000,ipl=0.0001,ppl=0,trf=0,fa=45,bwtp=4 -1 3:3:1 -2 1:1:1 simu_ode.ra ;\
	$(TOOLDIR)/sim --sim ir-bssfp,tr=0.0045,te=0.00225,nrep=1000,ipl=0,ppl=0,trf=0,fa=45,bwtp=4 -1 3:3:1 -2 1:1:1 simu_hp.ra ;\
...
tests/test-sim-ode-hp-bssfp: sim nrmse
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)						;\
	$(TOOLDIR)/sim --sim bssfp,tr=0.0045,te=0.00225,nrep=1000,ipl=0.0001,ppl=0,trf=0,fa=45,bwtp=4 -1 3:3:1 -2 1:1:1 simu_ode.ra ;\
	$(TOOLDIR)/sim --sim bssfp,tr=0.0045,te=0.00225,nrep=1000,ipl=0,ppl=0,trf=0,fa=45,bwtp=4 -1 3:3:1 -2 1:1:1 simu_hp.ra ;\
	$(TOOLDIR)/nrmse -t 0.00015 simu_hp.ra simu_ode.ra			    	;\
	rm *.ra ; cd .. ; rmdir $(TESTS_TMP)
	touch $@
