...
extern struct reg2 tgv_reg(unsigned long flags, unsigned long jflags, float lambda, int N, const long in_dims[N], long isize, long* ext_shift, int tvscales_N, const float tvscales[tvscales_N]);
