...
extern void md_calc_fmac3_dims(long N, long squash, long dims1[__VLA(N)], long dims2[__VLA(N)], long out_dims[__VLA(N)]);
extern void md_fmac3(long N, long dims1[__VLA(N)], _Complex float* input1, long dims2[__VLA(N)], _Complex float* input2, long out_dims[__VLA(N)], _Complex float* out_data);
extern void md_fmacc3(long N, long dims1[__VLA(N)], _Complex float* input1, long dims2[__VLA(N)], _Complex float* input2, long out_dims[__VLA(N)], _Complex float* out_data);
