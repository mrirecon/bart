...
extern void md_zsample(int N, const long dims[__VLA(N)], complex float* z, sample_fun_t fun);
extern void md_parallel_zsample(int N, const long dims[__VLA(N)], complex float* z, sample_fun_t fun);
