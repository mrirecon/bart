...
extern void debug_delayed_queue(int dl, struct list_s* ops_queue);
extern void delayed_compute(void);

extern _Bool is_delayed(const void* ptr);
extern void delayed_overwrite(const void* ptr);
...
extern void delayed_optimize_queue_blocking(struct list_s* ops_queue);
