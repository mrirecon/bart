		...
		bool symmetric, bool conj)
{
	...
	if (!strided_call.long_dims && (   (((long)CFL_SIZE * INT_MAX / 2) < get_block_size(N_in, ndims, nostrs, CFL_SIZE))
					|| (((long)CFL_SIZE * INT_MAX / 2) < get_block_size(N_in, ndims, nistrs1, CFL_SIZE))
					|| (((long)CFL_SIZE * INT_MAX / 2) < get_block_size(N_in, ndims, nistrs2, CFL_SIZE)))) {
		...
		bool symmetric)
{
	...
	// FIXME: blas calls are not save with large input dimensions
	if (!strided_call.long_dims && (   (((long)FL_SIZE *INT_MAX / 2) < get_block_size(N_in, ndims, nostrs, FL_SIZE))
					|| (((long)FL_SIZE *INT_MAX / 2) < get_block_size(N_in, ndims, nistrs1, FL_SIZE))
					|| (((long)FL_SIZE *INT_MAX / 2) < get_block_size(N_in, ndims, nistrs2, FL_SIZE))))
		return false;
...
bool simple_fmacD(int N, const long dims[N], const long ostrs[N], double* out, const long istrs1[N], const float* in1, const long istrs2[N], const float* in2)
{
	...
	if (0 < N && (1 < tdims[0]) && (0 == tostrs[0]) && (FL_SIZE == tistrs1[0]) && (FL_SIZE == tistrs2[0])) {
		...
		optimized_threeop_oii(	N - 1, tdims + 1,
				...
				(size_t[3]){ (size_t)DL_SIZE, ((size_t)tdims[0] * FL_SIZE), ((size_t)tdims[0] * FL_SIZE) }, nary_inner_3op);
...
bool simple_zfmaccD(int N, const long dims[N], const long ostrs[N], complex double* out, const long istrs1[N], const complex float* in1, const long istrs2[N], const complex float* in2)
{
	...
	if (0 < N && (1 < tdims[0]) && (0 == tostrs[0]) && (CFL_SIZE == tistrs1[0]) && (CFL_SIZE == tistrs2[0])) {
		...
		optimized_threeop_oii(	N - 1, tdims + 1,
				tostrs + 1, (void*)out, tistrs1 + 1, (void*)in1, tistrs2 + 1, (void*)in2,
				(size_t[3]){ (size_t)CDL_SIZE, ((size_t)tdims[0] * CFL_SIZE), ((size_t)tdims[0] * CFL_SIZE) }, nary_inner_3op);
