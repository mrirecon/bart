...
extern void events_to_pulseq(struct pulseq *ps, enum block mode, double tr, struct seq_sys sys, int M, const struct rf_shape rf_shapes[__VLA(M)], int N, const struct seq_event ev[__VLA(N)]);
