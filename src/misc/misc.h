...
extern const char* ptr_append_printf(const char* prefix, const char* fmt, ...);
extern const char* ptr_vprintf(const char* fmt, va_list ap);
extern const char* ptr_print_dims(int D, const long dims[__VLA(D)]);
extern const char* ptr_append_print_dims(const char* prefix, int D, const long dims[__VLA(D)]);
