...
extern void normalizel1(int N, long flags, const long dims[__VLA(N)], _Complex float* maps);
extern void normalize(int N, long flags, const long dims[__VLA(N)], _Complex float* maps);
