...
extern void calc_ellipsoid(unsigned int D, long dims[D], _Complex float* out, _Bool kspace, long tdims[D], long tstrs[D], _Complex float* traj, float ax[3], long center[3], float rot, struct pha_opts* popts);
