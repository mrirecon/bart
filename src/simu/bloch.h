...
extern void bloch_mcconnel_matrix_ode(int P, float matrix[1 + P * 3][1 + P * 3], const float r1[P], const float r2[P], const float k[P][P], const float Th[P], const float Om[P], const float gb[3]);
extern void bloch_mcconnell_ode(int P, float out[P * 3], const float in[P * 3], const float r1[P], const float r2[P], const float k[P][P], const float Th[P], const float Om[P], const float gb[3]);
