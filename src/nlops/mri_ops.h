...
extern _Bool sense_model_get_noncart(struct config_nlop_mri_s* model);
...
extern const struct nlop_s* nlop_mri_fft_create(int Nb, struct config_nlop_mri_s* model);
extern const struct nlop_s* nlop_mri_nufft_create(int Nb, struct config_nlop_mri_s* model);
