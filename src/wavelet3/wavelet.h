...
extern void wavelet3_thresh(unsigned int N, float lambda, unsigned int flags, const long shifts[N], const long dims[N], complex float* out, const complex float* in, const const long minsize[N], long flen, const float filter[2][2][flen]);
